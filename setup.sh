...
sudo apt update
PACKAGES="git gitk vim xclip openjdk-8-jdk maven gradle ant python-pip python3-pip mc ncdu vlc p7zip-full etckeeper cmake g++ libwxgtk3.0-dev filezilla ncftp redshift redshift-gtk geoclue-2.0 htop"
